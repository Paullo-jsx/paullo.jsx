...
import minhafoto from '../../assets/profile1.png'

export default function Home() {
    return (
        <>
            <aside><h5>ESTE SITE AINDA ESTÁ EM DESENVOLVIMENTO</h5></aside>
            <Header />
                ...
                <div className={style.sobremim}>
                    <div className={style.cardsobremim}>
                        ...
                        <div className={style.social}>
                            <button><a className={style.social_icons} href="https://www.linkedin.com/in/antonio-paulo-74615025b/" target='_blank'><i className={style.i} class="bi bi-linkedin"></i></a></button>
                            <button><a className={style.social_icons} href="https://github.com/Paulo-developer?tab=repositories" target='_blank'><i className={style.i} class="bi bi-github"></i></a></button>
                            <button><a className={style.social_icons} href="mailto:antoniopaulodeveloper@gmail.com?" target='_blank'><i className={style.i} class="bi bi-envelope-fill"></i></a></button>
                        </div>
                    </div>
